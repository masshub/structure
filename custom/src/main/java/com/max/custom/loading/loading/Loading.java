...
import com.max.custom.loading.animation.FloatProperty;
import com.max.custom.loading.animation.IntProperty;

/**
 * Created by ybq.
 */
public abstract class Loading extends Drawable implements
    ...
    public Loading setAnimationDelay(int animationDelay) {
    ...
    public static final Property<Loading, Integer> ROTATE_X = new IntProperty<Loading>("rotateX") {
        @Override
        public void setValue(Loading object, int value) {
    ...
    public static final Property<Loading, Integer> ROTATE = new IntProperty<Loading>("rotate") {
        @Override
        public void setValue(Loading object, int value) {
    ...
    public static final Property<Loading, Integer> ROTATE_Y = new IntProperty<Loading>("rotateY") {
        @Override
        public void setValue(Loading object, int value) {
    ...
    @SuppressWarnings("unused")
    public static final Property<Loading, Integer> TRANSLATE_X = new IntProperty<Loading>("translateX") {
        @Override
        public void setValue(Loading object, int value) {
    ...
    @SuppressWarnings("unused")
    public static final Property<Loading, Integer> TRANSLATE_Y = new IntProperty<Loading>("translateY") {
        @Override
        public void setValue(Loading object, int value) {
    ...
    public static final Property<Loading, Float> TRANSLATE_X_PERCENTAGE = new FloatProperty<Loading>("translateXPercentage") {
        @Override
        public void setValue(Loading object, float value) {
            object.setTranslateXPercentage(value);
        }

        @Override
        public Float get(Loading object) {
            return object.getTranslateXPercentage();
        }
    };

    public static final Property<Loading, Float> TRANSLATE_Y_PERCENTAGE = new FloatProperty<Loading>("translateYPercentage") {
        @Override
        public void setValue(Loading object, float value) {
    ...
    @SuppressWarnings("unused")
    public static final Property<Loading, Float> SCALE_X = new FloatProperty<Loading>("scaleX") {
        @Override
        public void setValue(Loading object, float value) {
    ...
    public static final Property<Loading, Float> SCALE_Y = new FloatProperty<Loading>("scaleY") {
        @Override
        public void setValue(Loading object, float value) {
    ...
    public static final Property<Loading, Float> SCALE = new FloatProperty<Loading>("scale") {
        @Override
        public void setValue(Loading object, float value) {
    ...
    public static final Property<Loading, Integer> ALPHA = new IntProperty<Loading>("alpha") {
        @Override
        public void setValue(Loading object, int value) {
